...
public class Dom4jParseXmlDemo {
	 public void parseXml01(){  
	        try{  
	            //将src下面的xml转换为输入流  
	            InputStream inputStream = new FileInputStream(new File("C:/Users/lantone8/Desktop/xml/web.xml"));   
	            ...
	            Document document = saxReader.read(new File("C:/Users/lantone8/Desktop/xml/web.xml"));//必须指定文件的绝对路径  
	            ...
	            System.out.println("根节点id属性的值：" + rootElement.attributeValue("servlet"));//获取节点的属性id的值  
